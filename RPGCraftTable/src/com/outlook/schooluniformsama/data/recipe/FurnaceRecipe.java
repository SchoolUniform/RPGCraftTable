...
public class FurnaceRecipe extends Recipe{
	...
	public FurnaceRecipe(String name,String fileName,int needTime,int saveTime,double minTemperature,
			double maxTemperature,List<String> shape, HashMap<Character, ItemStack> materials,ItemStack[] product){
		super(name, fileName, WorkbenchType.FURNACE,shape,needTime);
	...
	public static FurnaceRecipe load(String name,String fileName){
		 ...
		 return new FurnaceRecipe(name,fileName,recipe.getInt(name+".needTime"),recipe.getInt(name+".saveTime"),
